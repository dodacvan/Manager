...
<div class="col-lg-7" style="padding-bottom: 120px">
	<form:form action="" method="POST" commandName="department">
		...
		<div class="form-group">
			...
			<form:input type="text" class="form-control" path="officephone"/>
		</div>
		...
		<div class="form-group">
			...
			<form:select class="form-control" path="manager.id">
				...
				<option <c:if test="${emp.id eq department.manager.id}">selected="selected"</c:if> value="${emp.id}">${emp.name}</option>
				</c:forEach>
			</form:select>
		</div>
		<button type="submit" class="btn btn-default">Edit Department
		</button>
